...
// ═══════════════════════════════════════════════════════════════════════════
// Select ONE UTxO for both Semaphore + Voting mints (reuse same OutputReference)
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
// Prepare Semaphore + Voting validators (same OutputReference for both)
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
// Create datums and assets for Semaphore + Voting NFTs
// ═══════════════════════════════════════════════════════════════════════════
...
const semaphoreDatum = conStr(0, [
  byteString(groupPolicyId),     // References existing Group NFT policy
  integer(0),                     // Empty merkle root
  byteString(nullHash),           // Empty nullifier MPF root
  createOutputReference(vkeyRefTxHash, vkeyRefOutputIndex) // Vkey ref
]);
...
const urnaDatum = createUrnaDatum({
  ...
  eventStart,
  eventEnd,
  semaphoreNftPolicyId: semaphorePolicyId  // References Semaphore NFT policy
});
...
if (response.ok) {
  ...
  console.log('\n📊 Minted NFTs:\n');
  console.log('1️⃣  Semaphore NFT');
  console.log('   Policy ID:', semaphorePolicyId);
  console.log('   Asset Name:', semaphoreAssetName);
  console.log('   Output Index: 0\n');

  console.log('2️⃣  Voting NFT');
  console.log('   Policy ID:', votingPolicyId);
  console.log('   Asset Name:', votingAssetName);
  console.log('   Output Index: 1\n');

  console.log('✅ Voting system setup completed!');
  console.log('🔗 References existing Group NFT:', groupPolicyId);
